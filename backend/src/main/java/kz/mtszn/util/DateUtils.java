...
public class DateUtils {
    ...
    public static ZonedDateTime firstDayOfMonth(final ZonedDateTime zonedDateTime) {
        return ZonedDateTime.of(LocalDate.of(zonedDateTime.getYear(), zonedDateTime.getMonth(), zonedDateTime.with(TemporalAdjusters.firstDayOfMonth()).getDayOfMonth()), LocalTime.of(0, 0, 0), ZoneId.of("Asia/Almaty"));
    }

    public static ZonedDateTime lastDayOfMonth(final ZonedDateTime zonedDateTime) {
        return ZonedDateTime.of(LocalDate.of(zonedDateTime.getYear(), zonedDateTime.getMonth(), zonedDateTime.with(TemporalAdjusters.lastDayOfMonth()).getDayOfMonth()), LocalTime.of(23, 59, 59), ZoneId.of("Asia/Almaty"));
    }
}

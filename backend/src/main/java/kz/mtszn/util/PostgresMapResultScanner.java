...
public class PostgresMapResultScanner implements IMapResultScanner {

    private final Map<String, Object> map;
    private boolean withCheck = true;

    public PostgresMapResultScanner(Map<String, Object> map) {
        this.map = map;
    }

    public PostgresMapResultScanner(Map<String, Object> map, boolean withCheck) {
        this.map = map;
    ...
    @Override
    public <T extends Enum<T>> T getEnum(String fieldName, Class<T> enumType) {
        return EnumUtils.valueOfOrNull(enumType, getString(fieldName));
    }
